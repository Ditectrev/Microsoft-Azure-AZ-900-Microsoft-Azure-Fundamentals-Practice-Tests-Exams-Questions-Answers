...
|374 | [After you create a virtual machine, you need to modify to allow connections to TCP port 8080 on the virtual machine [...].](#to-complete-the-sentence-select-the-appropriate-option-in-the-answer-area-hot-area-after-you-create-a-virtual-machine-you-need-to-modify-to-allow-connections-to-tcp-port-8080-on-the-virtual-machine)|
