...
|614 | [You have an Azure environment that contains 10 web apps. To which URL should you connect [1] to manage all the Azure resources? https://[1].[2].com.](#to-which-url-should-you-connect-1-to-manage-all-the-azure-resources-https//12com-hot-area-1)|
|615 | [You have an Azure environment that contains 10 web apps. To which URL should you connect [2] to manage all the Azure resources? https://[1].[2].com.](#to-which-url-should-you-connect-1-to-manage-all-the-azure-resources-https//12com-hot-area-2)|
