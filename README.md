...
|289 | [Azure Firewall will encrypt all the network traffic sent from Azure to the Internet.](#azure-firewall-will-encrypt-all-the-network-traffic-sent-from-azure-the-internet)|
