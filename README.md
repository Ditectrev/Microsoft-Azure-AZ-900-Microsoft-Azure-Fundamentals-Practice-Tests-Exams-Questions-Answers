...
|491 | [You can use in Azure to send email alerts when the cost of the current billing period for an Azure subscription exceeds a specified limit.](#you-can-use-in-azure-to-send-email-alerts-when-the-cost-of-the-current-billing-period-for-an-azure-subscription-exceeds-a-specified-limit)|
