...
|526 | [The Microsoft Service Trust Portal can be accessed by using a Microsoft cloud services account.](#the-microsoft-service-trust-portal-can-be-accessed-by-using-a-microsoft-cloud-services-account)|
